...
const SplashScreen = ({ onFinish }) => {
  useEffect(() => {
    const timer = setTimeout(onFinish, 2500); // auto-unmount after 2.5s
...
const HomePage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>ChatApp - Future of Messaging</title>
        <meta name="description" content="Chat faster, safer, and smarter with ChatApp. Enjoy real-time chat, calls, and file sharing with end-to-end encryption." />
      ...
      {!showSplash && (
        <div className="min-h-screen bg-gradient-to-br from-base-100 via-primary/5 to-secondary/10 flex flex-col">
          {/* Hero Section */}
          <section className="flex flex-col md:flex-row items-center justify-between px-6 md:px-10 py-20 md:py-24 gap-12">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h1 className="text-4xl md:text-6xl font-extrabold leading-tight text-primary drop-shadow-lg">
              ...
              <div className="flex gap-4">
                <Link
                  to="/login"
                  className="btn btn-primary px-6 md:px-8 py-3 rounded-xl text-base md:text-lg shadow-lg hover:scale-105 transition"
                ...
                <Link
                  to="/about"
                  className="btn btn-outline btn-secondary px-6 md:px-8 py-3 rounded-xl text-base md:text-lg hover:scale-105 transition"
                  aria-label="Learn more about ChatApp"
                >
                  Learn More
                </Link>
              </div>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <div className="w-[300px] md:w-[360px] rounded-3xl shadow-2xl backdrop-blur-lg bg-white/70 border border-gray-200 overflow-hidden">
          ...
          {/* Features Section */}
          <section className="px-6 md:px-10 py-20 bg-base-200/50 backdrop-blur-sm">
            <motion.h2
          ...
          <section className="px-6 md:px-10 py-20 bg-gradient-to-r from-primary/10 to-secondary/10">
          ...
          {/* Call To Action */}
          <motion.section
            className="text-center py-20 md:py-24 bg-gradient-to-r from-primary to-secondary text-white"
            initial={{ opacity: 0 }}
          ...
          >
            ...
            <Link
              to="/login"
              className="btn bg-white text-primary font-bold px-8 md:px-12 py-3 md:py-4 rounded-2xl text-lg shadow-xl hover:scale-110 transition"
              aria-label="Create your ChatApp account"
            >
              🚀 Create Your Account
            </Link>
          </motion.section>
